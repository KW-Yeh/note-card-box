      ...
      <div className="space-y-4">
        <div className="rounded-lg bg-muted/50 p-4">
          ...
          <p className="text-sm text-muted-foreground">
            卡片盒筆記法（Zettelkasten）是由德國社會學家 Niklas Luhmann 發明的知識管理方法。
            他用這套方法在學術生涯中發表了超過 70 本書和 400 篇論文。
          </p>
        </div>
        <div className="rounded-lg bg-muted/50 p-4">
          <h4 className="mb-2 font-medium flex items-center gap-2">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>• <strong>原子化筆記</strong>：每張卡片只記錄一個想法</li>
            <li>• <strong>用自己的話</strong>：用自己理解的方式重新表達</li>
            <li>• <strong>建立連結</strong>：將相關想法連接起來形成知識網絡</li>
            <li>• <strong>持續累積</strong>：讓知識隨時間複利成長</li>
          </ul>
        </div>
      </div>
    ),
        ...
        <div className="rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 p-4">
          ...
          <ol className="space-y-3 text-sm">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>整理歸納</strong>：定期檢視靈感筆記，將有價值的想法轉為「永久筆記」
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-xs text-primary-foreground">
...
export function OnboardingDialog({ forceOpen, onComplete }: OnboardingDialogProps) {
